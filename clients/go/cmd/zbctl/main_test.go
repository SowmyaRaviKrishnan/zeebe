...
var tests = []testCase{
	...
	},
	{
		...
		cmd:        strings.Fields("--insecure deploy testdata/model.bpmn testdata/job_model.bpmn testdata/deploy_form.form --resourceNames=model.bpmn,job.bpmn,deploy_form.form"),
